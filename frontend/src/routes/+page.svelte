...
<div class="container mx-auto p-4 md:p-6">
	<div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
		<div class="flex items-center gap-4">
			<img src="/logo.svg" alt="TailTunnel" class="w-12 h-12 md:w-16 md:h-16" />
			<div>
				<h1 class="text-2xl md:text-4xl font-bold tracking-tight">TailTunnel</h1>
				<p class="text-muted-foreground text-sm md:text-base mt-1">SSH into your Tailscale machines</p>
			</div>
		</div>
		<button
